        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
            <div className="bg-white dark:bg-slate-900 rounded-xl p-6 border border-slate-200 dark:border-slate-800">
                <div className="flex justify-between items-center mb-4">
                     ...
                     <button title="Derived from public.ai_request_logs and public.enrichment_dlq" className="text-slate-400">ⓘ</button>
                </div>
                <div className="text-4xl font-bold text-indigo-500">{qualityScore.toFixed(1)}%</div>
                <div className="text-sm text-slate-500 mt-2">
                    {metrics.schema_failures || 0} Eng. Failures | {metrics.prompt_drift_incidents || 0} Ped. Failures
                </div>
            </div>
            ...
            <div className="bg-white dark:bg-slate-900 rounded-xl p-6 border border-slate-200 dark:border-slate-800">
                <div className="flex justify-between items-center mb-4">
                     ...
                     <button title="public.synonym fields completion percentages" className="text-slate-400">ⓘ</button>
                </div>
