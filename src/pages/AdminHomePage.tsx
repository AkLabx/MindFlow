...
import { ShieldAlert, Bell, Upload, Brain, ArrowLeft, BookOpen } from 'lucide-react';
    ...
    return (
        <div className="min-h-screen pt-4 pb-24 px-4 w-full flex flex-col relative overflow-hidden bg-slate-50 dark:bg-slate-950">
            ...
            <div className="relative z-10 w-full max-w-lg mx-auto flex flex-col gap-6">
                ...
                {/* AI Enrichment Center Button */}
                <motion.div
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
                    onClick={() => navigate('/admin/enrichment')}
                    className="relative group cursor-pointer rounded-3xl p-6 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-xl overflow-hidden"
                >
                    ...
                    <div className="flex items-center gap-4 relative z-10">
                        ...
                        <div>
                            <h2 className="text-xl font-bold text-slate-800 dark:text-slate-100">AI Enrichment Center</h2>
                            <p className="text-sm text-slate-500 mt-1">Manage lexical pipeline, quotas, and DLQ.</p>
                        </div>
                    </div>
                </motion.div>
                ...
                >
                    ...
                    <div className="flex items-center gap-4 relative z-10">
                        ...
                        <div>
                            <h2 className="text-xl font-bold text-slate-800 dark:text-slate-100">Mock Tests CMS</h2>
                            <p className="text-sm text-slate-500 mt-1">Manage Categories, Series, and Tests.</p>
                        </div>
                    </div>
                </motion.div>
